"""Add user_node_traffic_history for daily traffic calculation.
...
cycle. Enables computing daily traffic by summing deltas:
SUM(delta_bytes) WHERE recorded_at >= start of today.
"""
